      ...
      <div className="bg-gray-50 border-b border-gray-100 px-6 py-10">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm text-gray-500 max-w-lg leading-relaxed">
            A complete training program for working in Japan under the SSW visa, combining Japanese language and industry-specific skills.
          </p>

          <div className="flex gap-2 mt-3 flex-wrap">
            {['SSW Visa', 'N4 Level', 'Job Placement Support'].map(c => (
        ...
        <div className="grid grid-cols-[1fr_280px] gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="border border-gray-100 rounded-xl p-4">
              ...
              <div className="mb-2">
                <div className="text-[11px] text-gray-400">Target Level</div>
                <div className="text-sm">JLPT N4 or above</div>
              </div>

              <div className="mb-2">
                <div className="text-[11px] text-gray-400">Eligibility</div>
                <div className="text-sm">High school graduate</div>
              </div>

              <div>
                <div className="text-[11px] text-gray-400">Outcome</div>
                <div className="text-sm">Work in Japan (SSW Visa)</div>
              </div>
            </div>
            ...
            <div className="bg-teal-50 border border-teal-100 rounded-xl p-4">
              ...
              <Link href="/contact" className="block text-center bg-teal-700 text-white text-sm font-medium py-2 rounded-lg">
                Apply now
              </Link>
            </div>
