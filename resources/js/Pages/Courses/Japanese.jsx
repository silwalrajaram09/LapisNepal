            ...
            <div className="bg-gray-50 border-b border-gray-100 px-6 py-10">
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-sm text-gray-500 max-w-lg leading-relaxed">
                        From beginner to advanced levels, this course prepares
                        students for daily life, academic success, and
                        professional opportunities in Japan.
                    </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-6 lg:gap-8">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="border border-gray-100 rounded-xl p-4">
                            ...
                            {[
                                ...
                                <Link
                                    key={r}
                                    href="/courses"
                                    className="block text-xs text-gray-500 hover:text-gray-800 border border-gray-100 rounded-lg px-3 py-2 mb-2 hover:border-gray-300 transition-colors"
                                >
                                    {r} →
                                </Link>
                            ))}
                        ...
                        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                            ...
                            <Link
                                href="/contact"
                                className="block text-center bg-blue-700 text-white text-sm font-medium py-2 rounded-lg"
                            >
                                Apply now
                            </Link>
                        </div>
