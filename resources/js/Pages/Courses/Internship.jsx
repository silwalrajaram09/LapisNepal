            ...
            <div className="bg-gray-50 border-b border-gray-100 px-6 py-10">
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-sm text-gray-500 max-w-lg leading-relaxed">
                        Gain real-world experience in Japanese companies through
                        structured internship opportunities across multiple
                        industries.
                    </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-6 lg:gap-8">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="bg-red-50 border border-red-100 rounded-xl p-4">
                            ...
                            <Link
                                href="/contact"
                                className="block text-center bg-red-700 text-white text-sm font-medium py-2 rounded-lg"
                            >
                                Apply now
                            </Link>
                        </div>
