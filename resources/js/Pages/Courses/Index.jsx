            ...
            >
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-sm text-gray-500 max-w-lg leading-relaxed">
                        All programmes are fully licensed and taught by
                    ...
                    <AnimatePresence mode="popLayout">
                        {visible.map((course) => (
                            <motion.div
                                ...
                                whileHover={{
                                    y: -3,
                                    boxShadow: "0 8px 28px 0 rgba(0,0,0,0.07)",
                                    borderColor: "#d1d5db",
                                }}
                                transition={{
                                    type: "spring",
                                    ...
                                    <div className="flex items-start justify-between gap-2 mb-3">
                                        ...
                                        >
                                            <svg
                                                className="w-5 h-5"
                                                viewBox="0 0 20 20"
                                                fill={course.iconColor}
                                            >
                                                <path d="M3 4h14v2H3zm0 5h9v2H3zm0 5h6v2H3z" />
                                            </svg>
                                        </div>
                                        <span
                                            className={`text-[11px] font-medium px-2.5 py-1 rounded-full ${course.badgeColor}`}
                                        >
                                            {course.badge}
                                        </span>
                                    </div>
                                ...
                                <div className="p-5 flex flex-col gap-3">
                                    <div className="flex gap-1.5 flex-wrap">
                                        {course.chips.map((chip) => (
                                            <span
                                                key={chip}
                                                className="text-[11px] text-gray-500 bg-gray-50 border border-gray-100 rounded-full px-2.5 py-1"
                                            >
                                                {chip}
                                            </span>
                                        ))}
                ...
                <div className="max-w-5xl mx-auto flex items-center justify-between gap-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Our counsellors will help — WhatsApp available for
                            students only.
                        </p>
                    </div>
                    <motion.a
