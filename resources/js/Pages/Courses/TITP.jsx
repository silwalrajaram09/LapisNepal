      ...
      <div className="bg-gray-50 border-b border-gray-100 px-6 py-10">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm text-gray-500 max-w-lg leading-relaxed">
            A structured program to gain technical skills and real-world work experience in Japan through training and internships.
          </p>

          <div className="flex gap-2 mt-3 flex-wrap">
            {['3–5 Year Track', 'Technical Skills', 'Japan Internship'].map(c => (
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="border border-gray-100 rounded-xl p-4">
              ...
              <div>
                ...
                <div className="text-sm">Technical Internship in Japan</div>
              </div>
            </div>
            ...
            <div className="border border-gray-100 rounded-xl p-4">
              ...
              {[
                ...
                <div key={field} className="text-xs text-gray-500 border border-gray-100 rounded-lg px-3 py-2 mb-2">
                  {field}
                </div>
              ))}
            </div>
            ...
            <div className="border border-gray-100 rounded-xl p-4">
              ...
              {[
                ...
                <div key={req} className="text-xs text-gray-500 mb-1">
                  • {req}
                </div>
              ))}
            </div>
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-xl p-4">
              ...
              <Link href="/contact" className="block text-center bg-amber-700 text-white text-sm font-medium py-2 rounded-lg">
                Apply now
              </Link>
            </div>
