      ...
      <section className="max-w-5xl mx-auto px-6 py-16 grid grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-4xl font-medium leading-snug mb-4"
          >
            {t('home.title')}{' '}
          ...
          >
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
              <Link href="/courses" className="bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium inline-block">
                {t('home.explore')}
              </Link>
            </motion.div>
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
              <Link href="/contact" className="border border-gray-200 text-gray-800 px-5 py-2.5 rounded-lg text-sm inline-block">
                {t('home.getInTouch')}
              </Link>
            </motion.div>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                key={c.name}
                variants={cardVariant}
                whileHover={{ y: -4, boxShadow: '0 8px 24px rgba(0,0,0,0.07)', borderColor: '#d1d5db' }}
