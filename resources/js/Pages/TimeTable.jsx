...
const classes = [
    ...
    {
        programme: "SSW curriculum",
        level: "N4 + skills",
        days: "Sun–Fri",
        time: "7:00–10:00 am",
        batch: "Morning",
        batchColor: "bg-teal-50 text-teal-800",
    ...
    {
        programme: "TITP curriculum",
        level: "N5 + technical",
        days: "Sun–Fri",
        time: "8:00–11:00 am",
        batch: "Morning",
        batchColor: "bg-amber-50 text-amber-800",
        instructor: "Priya Adhikari",
        status: "Open",
        statusColor: "bg-green-50 text-green-800",
        cat: ["morning", "titp"],
    },
    {
        ...
        batch: "Weekend",
        batchColor: "bg-red-50 text-red-800",
        instructor: "Priya Adhikari",
        status: "Filling",
        statusColor: "bg-amber-50 text-amber-800",
        cat: ["titp"],
...
export default function Timetable() {
    ...
    const visible = classes.filter(
        (c) => active === "all" || c.cat.includes(active),
    );
        ...
        <AppLayout>
            ...
            >
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-sm text-gray-500 leading-relaxed">
                        Current batch schedules. New batches start every month.
                    </p>
                </div>
            </motion.div>
            <div className="max-w-5xl mx-auto px-6 py-8">
                ...
                <p className="text-xs text-gray-400 mt-3">
                    New batches start every month. Contact us to reserve your
                    seat.
                </p>
            </div>
        </AppLayout>
