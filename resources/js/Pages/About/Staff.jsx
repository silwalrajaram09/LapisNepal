...
export default function Staff({ staffMembers }) {
    // Use DB data if available, otherwise fallback to the hardcoded list (optional)
    const displayStaff =
        staffMembers && staffMembers.length > 0 ? staffMembers : staff;
        ...
        <AppLayout>
            ...
            <div className="max-w-5xl mx-auto px-6 py-8">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-xl p-6 flex gap-5 items-start mb-8">
                    <div className="w-14 h-14 rounded-full bg-blue-50 text-blue-800 flex items-center justify-center text-lg font-medium shrink-0">
                        S
                    </div>
                    <div>
                ...
                <div className="space-y-4 md:gap-6 mb-8 flex flex-col">
                    {displayStaff.map((s) => (
                        ...
                        >
                            <div
                                className={`w-11 h-11 rounded-full ${s.color || "bg-blue-50 text-blue-800"} flex items-center justify-center font-medium text-sm mb-3`}
                            >
